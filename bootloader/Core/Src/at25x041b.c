/*(*******************************************************
PROGRAM NAME - AT25X041b external flash driver

PROGRAMMER - Bertet Gabriel

SYSTEM - Currently working on a STM32G474RET6 with a 4Mb external flash

DATE - Started 01/03/2023

BUGS - No major bug ever reported. If you find a bug please report it on github

DESCRIPTION - Basic driver for the external flash driver
*******************************************************)*/
#include "at25x041b.h"
#include "main.h"
