...
/*Struct use for Inertial Measurement unit data*/
BNO055_t IMU_BNO055_struct;
/*Struct use to send command to the aicraft (can be control by supperior layer*/
...
/*Function use to convert float to string*/
